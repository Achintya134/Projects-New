    ...
    return <motion.div variants={projectVariant} className="relative">
        <div className={overlayStyles}>
            ...
            <p className="mt-7">
                ...
                At nemo, earum iure magni voluptatibus voluptatum esse, et in commodi dolorem 
                molestias adipisci perspiciatis eaque excepturi quod 
                impedit asperiores ex officia!
            </p>
...
const Projects =() =>{
    return(<section id="projects" className="pt-48 pb-48">
        {/* Headings */}
        <motion.div
                ...
                variants={{
                  ...
                  visible: { opacity: 1, y: 0 },
                    ...
                    <p className="mt-10 mb-10">
                        ...
                        sapiente facere doloribus quo consequatur aperiam maxime deserunt nobis. 
                        Sequi delectus natus quod, odit repudiandae ad numquam iste ducimus libero!
                    </p>
                </motion.div>
                {/* Projects */}
